package com.rrs_apps.android.auth;
...
/**
 * SherlockAccountAuthenticatorActivity provides the same functionality as the stock Android class, while also
 * supporting SherlockFragments within subclasses.
 */
public class SherlockAccountAuthenticatorActivity extends SherlockFragmentActivity {
